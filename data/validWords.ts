// A small subset of common 5-letter words for validation
// In a production app, this would be a much larger list or a server-side check.
export const VALID_WORDS = [
  ...
  "HUGE", "HUMAN", "IDEAL", "IMAGE", "INDEX", "INNER", "INPUT", "ISSUE", "JAPAN", "JIMMY",
  ...
  "MERCY", "PRAYR", "SALAH", "ZAKAT", "HALAL", "HARAM", "ISLAM", "QURAN", "SURAH", "AYAH",
  "MECCA", "KAABA", "HAJJ", "UMRAH", "IMAN", "DEEN", "DUNYA", "AKHRA", "JINN", "SABR"
];
